...
public class Medicamento {
    ...
    private ObjectId idMedicmento; // No se valida si actúa como un ID interno de la lista

    @NotBlank(message = "El nombre del medicamento es obligatorio")
    @Size(min = 2, max = 100, message = "El nombre del medicamento debe tener entre 2 and 100 caracteres")
    private String nombre;

    @NotBlank(message = "La dosis es obligatoria (ej. 5ml, 1 tableta)")
